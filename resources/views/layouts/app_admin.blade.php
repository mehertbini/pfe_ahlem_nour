    ...
    <header id="header" class="header">
        <div class="top-left">
            <div class="navbar-header">
                <a class="navbar-brand" href="{{url('/admin')}}"><img src="{{asset('admin_css/images/logo.png')}}" alt="Logo"></a>
                ...
                <div class="header-left">
                    ...
                    <div class="dropdown for-message">
                        ...
                        <div class="dropdown-menu" aria-labelledby="message">
                            ...
                            <a class="dropdown-item media" href="#">
                                <span class="photo media-left"><img alt="avatar" src="admin_css/images/avatar/1.jpg"></span>
                            ...
                            <a class="dropdown-item media" href="#">
                                <span class="photo media-left"><img alt="avatar" src="admin_css/images/avatar/2.jpg"></span>
                                <div class="message media-body">
                            ...
                            <a class="dropdown-item media" href="#">
                                <span class="photo media-left"><img alt="avatar" src="admin_css/images/avatar/3.jpg"></span>
                                <div class="message media-body">
                            ...
                            <a class="dropdown-item media" href="#">
                                <span class="photo media-left"><img alt="avatar" src="admin_css/images/avatar/4.jpg"></span>
                                <div class="message media-body">
